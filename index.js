    ...
    client.on('message', async message => {
        ...
        if (message.channel.type !== 'text') {
            ...
            if (!active || !found) {
                ...
                channel.overwritePermissions("517034076318990346", { //Role id (when someone join my server get this role with id <<, i dont know how to change it for @everyone. This will prevent users to see the channel, only admins will see!
                    VIEW_CHANNEL: false,
                    SEND_MESSAGES: false,
                    ADD_REACTIONS: false
                });
        ...
        if (support) {
            ...
            if (message.content.toLowerCase() === '/complete') {
                ...
                let inEmbed = new Discord.RichEmbed()
                    ...
                    .setColor('RANDOM')
                const staffChannel = client.channels.get('517033907447922698'); //Create a log channel and put id here
